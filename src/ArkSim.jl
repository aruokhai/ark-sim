...
module ArkSim
    ...
    function main()
        ...
        # visa_network = NetworkConfig(50_000, 100_000_000_000, 43_200, 1_000_000, 43_200, 0.000013657, Dict("high" => 0.1, "medium" => 0.6, "low" => 0.3))
        # adata, mdata = run_network(visa_network, 5000)
        visa_network = NetworkConfig(200, 100_000_000_000, 43_200, 1_000_000, 43_200, 0.59, Dict("high" => 0.1, "medium" => 0.6, "low" => 0.3))
        mdata = run_network(visa_network, 5)
        # println(mdata)
